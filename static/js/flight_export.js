...
var FlightExport = (function(){
    ...
    function payloadLabel(payload){
        ...
        if (payload.prediction){
            _bits.push("first recorded prediction");
        }
    ...
    function download(){
        ...
        if (el("exportCurrentGeofence").checked) _query += "&include_geofence=1";
        if (el("exportCurrentOverlays").checked) _query += "&include_overlays=1";
